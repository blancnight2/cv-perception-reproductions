...
def resolve_data_path(root_dir):
    """返回可用的 S3DIS 原始数据目录，优先匹配当前仓库的真实布局。"""
    candidate_paths = [
        os.path.join(root_dir, 'data', 'stanford_indoor3d', 'Stanford3dDataset_v1.2_Aligned_Version'),
        os.path.join(root_dir, 'data', 's3dis', 'Stanford3dDataset_v1.2_Aligned_Version'),
    ]
...
DATA_PATH = resolve_data_path(ROOT_DIR)
