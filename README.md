...
| 03 | YOLO + ByteTrack + TensorRT | 2D 检测·跟踪·部署量化 | KITTI | **mAP50 90.4% / mAP50-95 65.1%**（YOLO11s@960+rect）；TensorRT FP16 端到端 **175.5 FPS** |
...
| 07 | 视锥几何伪标签 | 点云 3D 自动标注 | KITTI | **零 3D 人工标注**下 BEV AP 达全监督 **62%**，严格 3D IoU 0.7 仅 21% |
