...
方向：自动驾驶感知 / 点云 / 三维重建 / 遥感

本仓库汇总我在**自建 Linux/CUDA 环境**（RTX 5070，Blackwell sm_120，CUDA 12.8，PyTorch 2.11+cu128）下，对若干经典/前沿感知与重建算法的**复现**。每个子目录含：上游代码、我的配置/脚本/环境适配与修复、以及**本机实测结果**（非论文照搬）。
